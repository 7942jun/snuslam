...
const mockSearchedUserList: User[] = [
  { id: 3, email: 'sogae@won.sil', password: 'oyeah', nickname: 'OLNL', position: 'PG',
    wins: 62, loses: 54, teams_id: [], point: 2653 },
  { id: 5, email: 'its@time.to.sleep', password: 'swag', nickname: 'GENIOUS', position: 'SG',
    wins: 16, loses: 19, teams_id: [1, 4], point: 1690 }
];
